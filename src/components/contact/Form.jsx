...
const Form = () => {
  ...
  return (
    <>
    <Toast isShow={showToast} isHide={() => setShowToast(false)} message="Pertanyaan telah tersubmit" />
          ...
          >
            ...
            <div className="space-x-4 p-[10px] flex flex-col self-center items-start">
              <div className="relative flex items-start self-stretch group">
                ...
                >
                  <div
                    className="modal-content w-[200px] md:w-[250px] lg:w-[250px] h-48 md:h-53 lg:h-56 text-start rounded-2xl bg-neutral-500 shadow-md"
                    style={{
                      boxShadow:
                        "0px 0px 5px rgba(0, 0, 0, 0.1), 0px 0px 5px rgba(0, 0, 0, 0.1)",
                    }}
                  >
              ...
              <div className="relative border-b-[1px] border-black">
                ...
                >
                  <p className="w-[180px] xsm:w-full">
                    {category === ""
                      ? "Silakan pilih kategori pertanyaan"
                      : category}
                  </p>
                </div>
                <svg
                  className={`absolute right-[16px] top-0 -z-10 ${
